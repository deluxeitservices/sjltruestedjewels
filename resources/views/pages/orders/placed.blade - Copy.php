...
<body>
  ...
  <p style="margin-top:14px;">
    Please fill out the required <strong>Compulsory Buying Form</strong>:
  </p>
  <p>
    <a href="{{ $declarationUrl }}" style="display:inline-block;background:#111;color:#fff;padding:10px 14px;text-decoration:none;border-radius:4px;">
