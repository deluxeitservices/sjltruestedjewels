    ...
    <div class="profile-card text-center">
        <div class="user-profile user-img">
            ...
            if (isset($userData->profile_picture)) {
                $profPic = asset('storage/uploads/userprofile/' . $userData->id . '/' . $userData->profile_picture);
                // ) asset('storage/' .$userData->profile_picture);
            } else {
                $profPic = asset('images/default.png');
            }
            ?>
            <img src="{{ $profPic }}" alt="" class="rounded-circle object-fit-cover" height="60px" width="60px">
        </div>
        ...
        <div class="sidebar-menu">
            ...
            <a href="{{ url('/dashboard') }}" class="main-box d-flex gap-2 align-items-center p-3 mb-2 text-decoration-none desbor-icon m-0 {{ request()->is('dashboard') ? 'active' : '' }}">
            ...
            <a href="{{ url('/order') }}" class="main-box d-flex gap-2 align-items-center p-3 mb-2 text-decoration-none desbor-icon m-0 {{ request()->is('order') || request()->is('order/*') ? 'active' : '' }}">
            ...
            <a href="{{ url('/wishlist') }}" class="main-box d-flex gap-2 align-items-center p-3 mb-2 text-decoration-none desbor-icon m-0 {{ request()->is('wishlist') ? 'active' : '' }}">
