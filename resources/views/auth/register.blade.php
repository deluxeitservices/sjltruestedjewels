    ...
    <div class="container">
      ...
      <div class="row register-row">
        ...
        <div class="col-md-7 col-12">
          ...
          @enderror
          <form method="POST" action="{{ route('register') }}" class="needs-validation register-form" novalidate>
            @csrf
            <div class="row g-3">
              ...
              <div class="col-md-12 position-relative">
                <div class="form-outline" data-mdb-input-init>
                  <input type="email" name="email" class="form-control"
                    id="validationTooltip04" value="{{ old('email') }}" required />
              ...
              <div class="col-md-6 position-relative">
                <div class="form-outline" data-mdb-input-init>
                  ...
                  <input type="password" class="form-control"
                    id="validationTooltip06" name="confirm_password" value="{{ old('confirm_password') }}" required />
              ...
              <div class="col-12">
                <a href="#"><button
                    ...
                    data-mdb-ripple-init><i
                      class="fa-solid fa-user-plus"></i> Create
                    Account</button></a>
