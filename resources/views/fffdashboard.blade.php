            ...
            <div class="col-lg-3 col-md-12">
                <div class="profile-card text-center">
                    ...
                    <div class="sidebar-menu">
                        ...
                        <a href="{{ url('/dashboard') }}" class="main-box d-flex gap-2 align-items-center p-3 mb-2 text-decoration-none desbor-icon m-0 active">
                        ...
                        <a href="{{ url('/wishlist') }}"  class="main-box d-flex gap-2 align-items-center p-3 mb-2 text-decoration-none desbor-icon m-0">
