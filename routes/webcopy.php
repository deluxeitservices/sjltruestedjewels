...
// Route::get('/{search}', [ExternalCatalogController::class,'index'])->name('ext.catalog');
Route::get('/bullion', [ExternalCatalogController::class,'index'])->name('ext.catalog.bullion');
Route::get('/preowned', [ExternalCatalogController::class,'index'])->name('ext.catalog.preowned');
Route::get('/diamond', [ExternalCatalogController::class,'index'])->name('ext.catalog.diamond');
Route::get('/bullion/product/{slug}', [ExternalCatalogController::class,'show'])->name('ext.product.bullion');
Route::get('/preowned/product/{slug}', [ExternalCatalogController::class,'show'])->name('ext.product.preowned');
Route::get('/diamond/product/{slug}', [ExternalCatalogController::class,'show'])->name('ext.product.diamond');
...
Route::post('/bullion/cart/add', [ExternalCatalogController::class, 'addToCart'])->name('ext.cart.add.bullion');
Route::post('/preowned/cart/add', [ExternalCatalogController::class, 'addToCart'])->name('ext.cart.add.preowned');
Route::post('/diamond/cart/add', [ExternalCatalogController::class, 'addToCart'])->name('ext.cart.add.diamond');
