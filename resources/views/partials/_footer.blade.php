            ...
            <div class="row">
                <div class="col-md-4 col-12">
                    <div class="contact-box slider-down-load">
                        <a href="https://mail.google.com/mail/?view=cm&to=shivanijewellers.uk@gmail.com"
                            onclick="window.open(
                        'https://mail.google.com/mail/?view=cm&fs=1&to=shivanijewellers.uk@gmail.com&su=Jewellery%20Inquiry&body=Hello%20Shivani%20Jewellers,',
                        'gmailPopup',
                        'width=600,height=550,top=100,left=400,scrollbars=no,resizable=no'
                      ); return false;">
                            <div class="icon-box">
                        ...
                        <h6><a
                                href="https://mail.google.com/mail/?view=cm&to=shivanijewellers.uk@gmail.com"
                                onclick="window.open(
                        'https://mail.google.com/mail/?view=cm&fs=1&to=shivanijewellers.uk@gmail.com&su=Jewellery%20Inquiry&body=Hello%20Shivani%20Jewellers,',
                        'gmailPopup',
                        'width=600,height=550,top=100,left=400,scrollbars=no,resizable=no'
                      ); return false;">Click</a></h6>
                        ...
                        'gmailPopup',
                        'width=600,height=550,top=100,left=400,scrollbars=no,resizable=no'
                      ); return false;">shivanijewellers.uk@gmail.com</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-12">
                    <div class="contact-box slider-down-load">
                        <a href="#"
                            onclick="window.open('tel:+447477068003','callPopup','width=400,height=300'); return false;">
                            <div class="icon-box">
                                <i class="fa-solid fa-phone"></i>
                            </div>
                        </a>
                        <h6><a href="tel:+44 7477 068003" onclick="window.open('tel:+447477068003','callPopup','width=400,height=300'); return false;">Call</a></h6>
                        <div class="link-box"><a href="tel:+447477068003">+44 7477 068003</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-12">
                    <div class="contact-box slider-down-load" onclick="openMapPopup()">
                        <div class="icon-box">
...
<footer class="footer pt-5">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <ul class="social-media">
                        <li><a href="#" class=" text-decoration-none"><i class="fa-brands fa-facebook"></i></a>
                        </li>
                        <li><a href="#" class="text-decoration-none"><i class="fa-brands fa-instagram"></i></a>
                        </li>
                        <li><a href="#" class=" text-decoration-none"><i class="fa-brands fa-whatsapp"></i></a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-lg-2 col-md-6 col-12">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{ route('ext.catalog', ['category' => 'bullion', 'category_slug' => 'gold-bars']) }}"
                                class=" text-decoration-none">Shop Gold</a></li>
                        <li><a href="{{ route('ext.catalog', ['category' => 'bullion', 'category_slug' => 'silver-bars']) }}"
                ...
                <div class="col-lg-2 col-md-6 col-12">
                    <h6>Selling</h6>
                    <ul class="list-unstyled">
                        <li> <a href="{{ route('sellgold.index') }}" class="text-decoration-none d-block">Sell
                                Gold</a>
                        </li>
                        <li>
                            <a href="{{ route('sellsilver.index') }}" class="text-decoration-none d-block">Sell
                                Silver</a>
                        </li>
                        <li>
                            <a href="{{ route('sellplatinum.index') }}" class="text-decoration-none d-block">Sell
                                Platinum</a>
                        </li>
                        <li>
                            <a href="{{ route('sellpalladium.index') }}" class="text-decoration-none d-block">Sell
                                Palladium</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-lg-2 col-md-6 col-12">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="{{ route('ourshowroom.index') }}" class="text-decoration-none d-block ">Our
                                Showroom</a>
                        </li>
                        <li>
                            <a href="{{ route('guidetobuying.index') }}" class="text-decoration-none d-block ">Guide To
                                Buying</a>
                        </li>
                        <li>
                            <a href="{{ route('blog') }}" class="text-decoration-none d-block ">Blog</a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('privacypolicy.index') }}" class="text-decoration-none d-block ">Privacy
                                Policy
                            </a>
                        </li>
                        <li>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="subscribe-section">
                        ...
                        <form id="newsletterForm" class="d-flex flex-sm-row subscribe-div newsletter-form" novalidate>
                            ...
                            @csrf
                            <input id="newsletterEmail" name="email" type="email"
                                class="form-control mr-sm-2 mb-sm-0" placeholder="Your Email" required />
    ...
    <div class="mobile-view-footer">
                                ...
                                <div class="accordion-body">
                                    <ul class="list-unstyled">
                                        ...
                                        <li><a href="{{ route('ext.catalog', ['category' => 'bullion', 'category_slug' => 'silver-bars']) }}"
                                                class="text-decoration-none d-block ">Shop
                                                Silver</a></li>
                                        <li><a href="{{ route('vatfree.index') }}"
                                                class="text-decoration-none d-block">VAT
                                                Free</a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <ul class="list-unstyled">
                                        ...
                                        <li>
                                            <a href="blog.html" class="text-decoration-none d-block ">Blog</a>
                                        </li>
                            ...
                            <div id="collapsefour" class="accordion-collapse collapse" aria-labelledby="headingfour"
                                ...
                                <div class="accordion-body">
                                    <p>Subscribe to our weekly newsletter for skincare tips
                                        and updates.</p>
                                    <form id="newsletterForm" class="d-flex flex-sm-row subscribe-div newsletter-form"
                                        novalidate>
                                        @csrf
                                        <input id="newsletterEmail" name="email" type="email"
                                            class="form-control mr-sm-2 mb-sm-0" placeholder="Your Email" />
                                        <button class="btn" type="submit" id="newsletterBtn">Subscribe</button>
                                    </form>
                                    <div class="newsletter-msg mt-2" style="display:none;"></div>
     ...
     'width=600,height=550,top=100,left=400,scrollbars=no,resizable=no'
                                        ...
                                        <li>
                                            <a href="tel:+44 7477068003"><i class="fa-solid fa-phone"></i> +44 7477
                                                068003</a>
                                        </li>
                                    </ul>
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const getToken = (form) =>
            (form.querySelector('input[name=_token]') || document.querySelector('meta[name="csrf-token"]'))
            ?.value || '';
        ...
        FORMS.forEach(form => {
            form.addEventListener('submit', async (e) => {
                ...
                const msgBox = form.nextElementSibling?.classList.contains(
                        'newsletter-msg') ?
    ...
    function openMapPopup() {
        window.open(
            'https://www.google.com/maps?q=Unit+2,+281+Green+Street,+London,+E7+8PD',
            'mapPopup',
            'width=800,height=600,top=100,left=200,scrollbars=yes,resizable=yes'
        );
    }
</script>
