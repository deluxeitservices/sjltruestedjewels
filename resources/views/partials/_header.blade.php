  ...
  <header class="custom-header desktop-view-header">
    ...
    <div class="bottom-header">
      <div class="container">
                      ...
                      <div class="col-md-6 col-lg-2 mb-3 mb-lg-0">
                        ...
                        <div class="list-group list-group-flush">
                          ...
                          <a href="{{ route('ext.catalog', ['category' => 'bullion']) }}"
                            class="list-group-item list-group-item-action text-decoration-underline {{ $isActive ? 'active' : '' }}">
                            View All
                          </a>
                        </div>
        ...
        <form action="/bullion" method="GET" class="">
          <input type="hidden" name="sort" value="{{ request('sort') }}">

          <div class="d-flex gap-2 align-items-center searchBar d-none">
            <i class="bi bi-search position-absolute top-50 start-0 translate-middle-y ms-3"></i>

            <input type="text" id="searchInputDesk" name="search"
              class="form-control ui-autocomplete-input"
              placeholder="Search..."
              autocomplete="off">
            <button id="searchBtn" class="btn btn-outline-secondary btn-icon" type="submit" aria-label="Search">
              <i class="fa-solid fa-magnifying-glass"></i>
            </button>

            <button id="closeSearch" class="btn btn-outline-secondary btn-icon" type="button" aria-label="Close search">
