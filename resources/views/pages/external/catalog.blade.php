...
@section('content')
 <main class="product-listin-main">
              ...
              <div class="row">
                <div class="col-md-3 col-sm-12">
                  <div class="sidebar-stick sidebar-product">
                    <form method="GET" action="{{ route('ext.catalog') }}" id="filterForm" class="">
                        ...
                        <div class="side-title filter-box">
                          ...
                          <div class="filter-title d-flex gap-2 align-items-center reset-btn">
                            <a href="{{ route('ext.catalog') }}">Reset</a>
                          </div>
                        </div>
                          ...
                          <div class="alert alert-warning d-flex align-items-start gap-3" role="alert">
                            ...
                            <div>
                              ...
                              <div class="d-flex flex-wrap gap-2">
                                <a href="{{ route('ext.catalog') }}" class="btn btn-sm btn-outline-secondary">
                            ...
                            <div class="product-card h-100" data-label="BESTSELLER">
                              <div class="product-card-container">
                                <div class="product-img">
                                  <a href="{{ route('ext.product', $p['slug']) }}" class="block">
                                    <img src="{{ $p['image'] ?: asset('assets/images/placeholder-bar.svg') }}"
                                ...
                                <div class="product-info">
                                  ...
                                  <div class="price-eyes-section">
                                    ...
                                    <div>
                                      <form action="{{ route('ext.cart.add') }}" method="post" class="flex items-center gap-2">
                                        @csrf
  ...
  <div class="mt-6 flex gap-2">
    @if($cur > 1)
      <a class="px-3 py-1 border rounded" href="{{ route('ext.catalog', ['page'=>$cur-1,'per_page'=>$per_page]) }}">Prev</a>
    @endif
    @if($cur < $last)
      <a class="px-3 py-1 border rounded" href="{{ route('ext.catalog', ['page'=>$cur+1,'per_page'=>$per_page]) }}">Next</a>
    @endif
  </div>
</main>
@push('scripts')
