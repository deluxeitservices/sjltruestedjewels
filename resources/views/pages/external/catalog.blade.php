...
<main class="product-listin-main">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-12">
                            <div class="sidebar-stick sidebar-product">
                                <form method="GET" action="{{ route('ext.catalog', ['category' => $prefix]) }}"
                                    id="filterForm" class="">
                                                        ...
                                                        <div id="mainAccordionContent"
                                                            ...
                                                            <div class="accordion-body">
                                                                <div class="accordion" id="subAccordion">
                                                                    ...
                                                                    <div class="accordion-item border-0">
                                                                        ...
                                                                        <div data-bs-parent="#subAccordion">
                                                                            <div class="accordion-body d-flex">
                                                                                <div class="searbar-form-product"
                                                                                    id="searchForm">
                                                                                    ...
                                                                                    <button type="submit"
                                                                                        class="btn btn-custom-search ms-2">
                                                                    ...
                                                                    {{-- Category --}}
                                                                    @php
                                                                    $selectedCatSlugs = collect(
                                                                    (array) request('category_slug'),
                                                                    )
                                                                    ->map(fn($v) => strval($v))
                                                                    ->all();
                                                                        ...
                                                                        <div id="filterCategories"
                                                                            ...
                                                                            <div class="accordion-body gold-menu">
                                                                                <div class="gold-type-main">
                                                                                    ...
                                                                                    <label
                                                                                        class="text-decoration-none gold-type d-flex gap-2 flex-wrap mb-2 align-items-center">
                                                                                        <span
                                                                                        ...
                                                                                        <p class="gold-textm-0"
                                                                                            primary-color>
                                                                                            {{ $cat['name'] }}
                                                                                        </p>
                                                                                        @if (($cat['count'] ?? 0) > 0)
                                                                                        <span
                                                                                            class="ms-auto text-muted small">({{ $cat['count'] }})</span>
                                                                                        @endif
                                                                                    </label>
                                                                                    @endforeach
                                                                                </div>
                                                                    ...
                                                                    {{-- Brand --}}
                                                                    @php
                                                                    $selectedBrandSlugs = collect(
                                                                    (array) request('brand_slug'),
                                                                    )
                                                                    ->map(fn($v) => strval($v))
                                                                    ->all();
                                                                            ...
                                                                            <div class="accordion-body gold-menu">
                                                                                <div class="gold-type-main">
                                                                                    ...
                                                                                    <label
                                                                                        ...
                                                                                        @if (($b['count'] ?? 0) > 0)
                                                                                        <span
                                                                                            class="ms-auto text-muted small">({{ $b['count'] }})</span>
                                                                                        @endif
                                                                                    </label>
                                                                                    @endforeach
                                                                                </div>
                                                                    ...
                                                                    {{-- Weight --}}
                                                                    @php
                                                                    $selectedWeightSlugs = collect(
                                                                    (array) request('weight_option_slug'),
                                                                    )
                                                                    ->map(fn($v) => strval($v))
                                                                    ->all();
                                                                    $weightOpen =
                                                                    count($selectedWeightSlugs) > 0;
                                                                    @endphp
                                                                    <div class="accordion-item border-0">
                                                                        <h2 class="accordion-header p-0">
                                                                            <div class="accordion-button collapsed"
                                                                            ...
                                                                            <div class="accordion-body gold-menu">
                                                                                <div class="gold-type-main">
                                                                                    ...
                                                                                    <label
                                                                                        ...
                                                                                        @if (($w['count'] ?? 0) > 0)
                                                                                        <span
                                                                                            class="ms-auto text-muted small">({{ $w['count'] }})</span>
                                                                                        @endif
                                                                                    </label>
                                                                                    @endforeach
                                                                                </div>
                            ...
                            <div class="short-input">
                                <div class="row justify-content-end" bis_skin_checked="1">
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12" bis_skin_checked="1">
                                        <div class="form-group side-area product-side" bis_skin_checked="1">
                                            <select id="sortSelect" class="form-select" aria-label="sort-by">
                                                <option value="">SORT BY</option>
                                                <option value="price-asc"
                                                    {{ request('sort') === 'price-asc' ? 'selected' : '' }}>Price Low
                                                    to
                                                    High</option>
                                                <option value="price-desc"
                                                    {{ request('sort') === 'price-desc' ? 'selected' : '' }}>Price High
                                                    to
                                                    Low</option>
                                                <option value="newest"
                                                    {{ request('sort') === 'newest' ? 'selected' : '' }}>Latest
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="alert alert-warning alert-box" role="alert">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex flex-wrap gap-2 justify-content-center mt-3">
                                                    <a href="{{ route('ext.catalog', ['category' => $prefix]) }}"
                                                        class="btn common-primary-btn">
                                                    ...
                                                    <a href="{{ route(
                                                                    'ext.catalog',
                                                                    array_merge(['category' => $category], request()->except('page', 'category'), ['page' => 1]),
                                                                ) }}"
                                                        class="common-secondary-btn">
                                                ...
                                                <div class="mt-3 small text-muted">
                                                    ...
                                                    @if (request('search'))
                                                    <span class="badge bg-light text-dark">Search:
                                                        "{{ request('search') }}"</span>
                                                    @endif
                                                    ...
                                                    <span class="badge bg-light text-dark">Weight:
                                                        {{ $x }}</span>
                                                    @endforeach
                                                </div>
                                                @endif
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-6">
                                        <div class="product-card h-100 hover-product-card-table-{{ $p['external_id'] }} "
                                            data-label="SJL Trusted">
                                            <div class="product-card-container">
                                                <div class="product-img">
                                                    <a href="{{ route('ext.product', ['category' => $prefix, 'slug' => $p['slug']]) }}"
                                                        class="block">
                                                        <img src="{{ $p['image'] ?: asset('assets/image/logo-dark.svg') }}"
                                                            alt="{{ $p['title'] }}" class="img-fluid">
                                                    </a>
                                                    <!-- <button class="wishlist-btn"><i class="fa-regular fa-heart"></i></button> -->
                                                    @php
                                                    $isFavorited = in_array(
                                                    $p['external_id'],
                                                    $favoritedIds,
                                                    );
                                                    @endphp
                                                    <button class="wishlist-btn js-fav "
                                                        ...
                                                        <i
                                                            class=" fa-heart {{ $isFavorited ? 'fa-solid is-favorited' : 'fa-regular' }}"></i>
                                                    </button>

                                                </div>
                                                <div class="product-info">
                                                    <h6 class="product-title">
                                                        WG:{{ number_format($p['weight_g'] ?? 0, 3) }} g</h6>
                                                    <small>{{ $p['brand'] }} | SKU:
                                                        {{ $p['sku'] }}</small>
                                                    <div class="stock-box">
                                                        ...
                                                        @else
                                                        <p><img src="/assets/image/outof_stock.svg">Sold
                                                            Out</p>
                                                        @endif
                                                    </div>
                                                    <div class="price-eyes-section">
                                                        ...
                                                        <div>
                                                            ...
                                                            @else
                                                            <a
                                                                href="{{ route('ext.product', ['category' => $prefix, 'slug' => $p['slug']]) }}"><i
                                        ...
                                        <div class="hover-table-show d-none  {{ $p['external_id'] }}">
                                            <table class="tblPrice">
                                                <tbody>
                                                    <tr>
                                                        <th class="main-title-table-price">Quantity</th>
                                                        <th>Each</th>
                                                    </tr>
                                                    <tr>
                                                        <td>1</td>
                                ...
                                <div class="row">
                                    <nav aria-label="Page navigation product-pagination"
                                        ...
                                        <ul class="pagination">
                                            ...
                                            @for ($i = 1; $i <= $products->lastPage(); $i++)
                                                ...
                                                <li
                                                    ...
                                                    <a class="page-link paginatio-next"
    ...
    <div class="mt-6 flex gap-2">
        ...
        <a class="px-3 py-1 border rounded"
            href="{{ route('ext.catalog', ['category' => $prefix, 'slug' => $p['slug']], ['page' => $cur - 1, 'per_page' => $per_page]) }}">Prev</a>
        @endif
        @if ($cur < $last)
            <a class="px-3 py-1 border rounded"
            href="{{ route('ext.catalog', ['category' => $prefix, 'slug' => $p['slug']], ['page' => $cur + 1, 'per_page' => $per_page]) }}">Next</a>
            @endif
    </div>
</main>
@push('scripts')
...
<script>
    document.getElementById('filterForm').addEventListener('change', function(e) {
        const t = e.target;
        if (t.matches(
                'input[name="category_slug[]"], input[name="brand_slug[]"], input[name="weight_option_slug[]"]'
            )) {
            this.submit();
        }
    });
...
<script>
    ...
    $(document).on('mouseenter', '[class*="hover-product-card-table-"]', function() {
        // Hide all tables first
        $('.hover-table-show').addClass('d-none').css({
            position: '',
            top: '',
            left: '',
            width: ''
        ...
        const match = classes.match(/hover-product-card-table-(\d+)/);
        if (!match) return;
        const externalId = match[1];

        const $tableDiv = $('.hover-table-show.' + externalId);
        if ($tableDiv.length === 0) return;

        // Make the parent container relative (so the popup can be positioned inside it)
        const $parent = $(this).closest(
            '.row, .product-section, .container'); // adjust selector to your section
        $parent.css('position', 'relative');

        // Insert table inside parent (so it doesn’t break layout)
        $tableDiv.appendTo($parent);

        // Position table just below the card
        const cardTop = $(this).position().top; // relative to parent
    ...
    $(document).on('mouseleave', '[class*="hover-product-card-table-"]', function() {
        const classes = $(this).attr('class');
        const match = classes.match(/hover-product-card-table-(\d+)/);
        if (!match) return;
        const externalId = match[1];
...
$(document).ready(function() {
  $('.hover-product-card-table').hover(
    
    function() {
      // Mouse enter → remove d-none
      $(this).find('.hover-table-show').removeClass('d-none');
    },
    function() {
      // Mouse leave → add d-none again
      $(this).find('.hover-table-show').addClass('d-none');
    }
  );
});
</script> --}}
...
<script>
    function toggleAccordionByScreen() {
        const accordions = document.querySelectorAll('.filterby');
    ...
    // Run on page load
    toggleAccordionByScreen();

    // Run on window resize
    window.addEventListener('resize', toggleAccordionByScreen);
</script>